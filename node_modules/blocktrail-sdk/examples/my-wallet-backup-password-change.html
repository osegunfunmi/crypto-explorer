...
<header>
    ...
    <section>
        <div>
            ...
            <div><h3>Password Encrypted Secret</h3><code> library extra super animal door foam polar budget chicken session abandon about cherry atom brass square cute drop clump churn filter usage gesture rebuild carpet pioneer screen leader nice animal roof donkey pride young tennis clap nasty charge valve athlete globe shoot merry walnut phrase try retreat where hurt early copy moon keen more execute into flash glass blossom buzz </code></div>
        </div>
    </section>
